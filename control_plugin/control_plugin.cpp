...
namespace gazebo
{
      ...
      sdf::ElementPtr sdf)
  {
    ...
    ros::SubscribeOptions so =
      ros::SubscribeOptions::create<geometry_msgs::Twist>(command_topic_, 1,
          boost::bind(&ControlPlugin::cmdVelCallback, this, _1),
          ros::VoidPtr(), &queue_);
  ...
  {
#ifdef ENABLE_PROFILER
    IGN_PROFILE("ControlPlugin::UpdateChild");
  ...
  void ControlPlugin::cmdVelCallback(
      const geometry_msgs::Twist::ConstPtr& cmd_msg)
  {
    ROS_INFO_NAMED("planar_move", "cmdVelCallback");
